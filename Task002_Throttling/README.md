**Задача:** Реализуй метод, который принимает список строк (например, URL-адресов) и обрабатывает их асинхронно, но с жестким ограничением на максимальное количество одновременно выполняемых задач.
